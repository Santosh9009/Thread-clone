...
export default function RepostActivityCard({ activity }: { activity: any }) {
  return (
    <div className="activity-card repost-activity p-4 rounded-lg mb-4 bg-[#181818] border border-[#2e2e2e]">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center text-gray-300 space-x-2">
          <div>
            ...
            <span> reposted your thread</span>
          </div>
